...
void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(GPIOA, LCD_RS_Pin | LCD_E_Pin | LCD_DB4_Pin | LCD_DB7_Pin,
                    GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LCD_RS_Pin LCD_E_Pin LCD_DB4_Pin LCD_DB7_Pin */
  GPIO_InitStruct.Pin = LCD_RS_Pin | LCD_E_Pin | LCD_DB4_Pin | LCD_DB7_Pin;
  ...
  /*Configure GPIO pin : LCD_DB5_Pin */
